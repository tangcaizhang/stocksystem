...
import zzh.project.stocksystem.model.StockModel2;
...
public class StockModelJuheImpl2 implements StockModel2 {
    public static final String TAG = StockModelJuheImpl2.class.getSimpleName();
    private static StockModelJuheImpl2 sInstance;
    private FastVolley mFastVolley;
    private Gson mGson;
    private String HASHCODE;
    private String mAppKey;

    private StockModelJuheImpl2(Context context) {
    ...
    public static StockModelJuheImpl2 getInstance() {
        if (sInstance == null) {
            sInstance = new StockModelJuheImpl2(MyApplication.getInstance());
        }
        return sInstance;
    }
